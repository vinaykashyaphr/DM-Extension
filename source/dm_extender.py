...
from common_functions import NameAndCode, Refresh_DMC, Write_DMC, Write_PMC
    ...
    def __init__(self, inputpath: pathlib.Path, choice: bool):
        ...
        if choice == True:
            ...
            try:
                ...
                log.exception(
                    "DM Extension Addition Error:: {0}".format(addition_error))
        else:
            ...
            try:
                ...
                log.exception(
                    "DM Extension Removal Error:: {0}".format(removal_error))
    ...
    def __init__(self, rootdir: pathlib.WindowsPath,
        ...
        for dmref in all_dmrefs:
            ...
            if (actref != None) and (actref.attrib['infoCode'] == "00W"):
                ...
                if act != []:
                    act = valent(act.name, act.parent)
...
mainpath = pathlib.Path(input('Path:: '))  # pathlib.Path(sys.argv[1])
